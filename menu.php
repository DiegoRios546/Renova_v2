...
<nav class="navbar shadow menu d-block text-white">
  <div class="container mx-auto d-flex p-0 m-auto">
    ...
    <button class="navbar-toggler m-1 border-0 d-sm-none text-white" type="button" data-bs-toggle="collapse"
    ...
    <div class="d-flex">
      ...
      <a class="nav-icon position-relative text-decoration-none m-auto d-none d-sm-block">
        <button class="btn btn-success1 justify-content-center align-items-center d-flex text-white" data-toggle="modal"
          data-target="#loginModal" id="loginBtn">
  ...
  <div class="btn-group" role="group" aria-label="Basic example">
    <div class="dropdown">
      <button class="btn opciones text-white dropdown-toggle" type="button" data-bs-toggle="dropdown"
        aria-expanded="false">
        Servicios
      </button>
...
<div id="registerModal" class="modal fade" tabindex="4" role="dialog" aria-labelledby="tituloVentana"
  aria-hidden="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content p-0">
...
<div class="row collapse navbar-collapse flex-fill text-dark mx-auto m-1" id="templatemo_main_nav">
  <div class="mx-auto m-auto text-center d-flex">
    <a class="nav-link m-auto text-dark align-items-center" href="login.php"><i
        class="fa fa-fw fa-user text-dark m-auto"></i>
      <h6>Iniciar sesion</h6>
    </a>
    <a class="nav-link m-auto text-dark" href="index.php"><i class="fa fa-fw fa-tag text-dark m-auto"></i>
      <h6>Promociones</h6>
    </a>
    <a class="nav-link m-auto text-dark" href="index.php"><i class="fa fa-fw fa-book-open text-dark m-auto"></i>
      <h6>Catalogo</h6>
    </a>
  </div>
</div>
