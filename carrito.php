...
?>
    ...
    <section class="mx-auto justify-content-center p-3 d-flex">
        <div class="col-7 m-3">
            <!-- detalle del pedido -->
            <div class="card">
                <div class="card-body">
                    <h2 class="text-center">Detalle del pedido</h2>
                    <h4 class="text-center">Precios y disponibilidad de inventario válidos para esta ubicación.</h4>
                </div>
            </div>
            <!-- termina detalle del pedido -->
        ...
        <div class="col-4 m-3">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h4>Subtotal</h4>
                    <hr class="m-auto">
                    <h7>Total del pedido</h7>
                    <br>
                    <h8>Incluye impuestos</h8>
                </div>
             </div>
    ...
    <section class="py-5">
        <div class="container">
            <div>
                <h2 class="p-2 m-1 w-auto linea ">También te podría interesar...</h2>
            </div>
